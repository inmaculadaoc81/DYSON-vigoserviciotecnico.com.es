...
fallbackToggle.className = 'dynova-chat-fallback';
fallbackToggle.setAttribute('aria-label', 'Abrir chatbot DyNova');
...
if (target && !target.dataset.dynovaChatInitialized) {
  target.dataset.dynovaChatInitialized = 'true';
